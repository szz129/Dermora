  ...
  const captureAndAnalyze = async () => {
    try {
      ...
      if (todayScans.length >= 3) {
        ...
        Alert.alert("Daily Limit", "You've reached 3 scans today. Showing your averaged result!");
        return;
      }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.ageBadge}>
          <Text style={styles.ageBadgeText}>{CONDITION_LABELS[primaryCondition] || primaryCondition}</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  ageBadge: { backgroundColor: COLORS.secondaryPink, paddingVertical: 12, paddingHorizontal: 40, borderRadius: 15, marginTop: 30 },
  ageBadgeText: { fontSize: 18, color: COLORS.textMain, fontWeight: "600" },
